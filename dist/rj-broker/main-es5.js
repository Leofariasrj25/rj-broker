...
var ImoveisService = /** @class */ (function () {
    function ImoveisService() {
        var prologis_xy = new _models_Location__WEBPACK_IMPORTED_MODULE_3__["Location"]('Rio de Janeiro', 'Baixada Fluminense', 'Av. Guandú, 1000 - Jardim Alvorada, Queimados');
        var desc = "\u00C1rea de Terreno: 468.944,00 m\u00B2\n    \u00C1rea total constru\u00EDda: 162.022,00 m\u00B2\n    P\u00E9-direito: 12,0 m\n    Resist\u00EAncia de piso: 5 ton/m\u00B2\n    Docas (quantidade): 268\n    Sistema de Sprinklers: Sim\n    Ilumina\u00E7\u00E3o natural: Sim\n    Portaria Blindada: Sim\n    Sistema de seguran\u00E7a / CFTV: Sim\n    Espa\u00E7amento entre pilares (m): 22\u00D722\n    Vagas de estacionamento \u2013 ve\u00EDculos leves: 16\n    P\u00E1tio de manobras: Sim";
        var prologis_queimados = new _models_Imovel__WEBPACK_IMPORTED_MODULE_2__["Imovel"]('Prologis Queimados', 'Locação', 'Industrial', prologis_xy, desc);
